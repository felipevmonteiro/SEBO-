...
function FlowerIcon() {
    return (
      <SvgIcon>
          ...
          <g transform="translate(0.000000,577.000000) scale(0.080000,-0.080000)"
          ...
          66 196.601 220.766C213.202 220.766 223.031 210.979 223.031 194.749Z" fill="#FF8C02"/>
          </g>
          </svg>
        </SvgIcon>
    );
    ...
    <div>
      <Box borderColor="transparent">
        <StyledRating
          ...
          precision={1}
          icon={<FlowerIcon className = "icon" />}
        />
      </Box>
    </div>
  );
